...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Dpim Channel</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link es.unizar.disco.dice.DPIM.DpimChannel#getRate <em>Rate</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.DpimChannel#getMessageBroker <em>Message Broker</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.DpimChannel#getChannelDescription <em>Channel Description</em>}</li>
 * </ul>
 *
 * @see es.unizar.disco.dice.DPIM.DPIMPackage#getDpimChannel()
 * @model
 * @generated
 */
public interface DpimChannel extends DaConnector {
	/**
	 ...
	 * @see #setRate(String)
	 * @see es.unizar.disco.dice.DPIM.DPIMPackage#getDpimChannel_Rate()
	...
	/**
	 * Sets the value of the '{@link es.unizar.disco.dice.DPIM.DpimChannel#getRate <em>Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unizar.disco.dice.DPIM.DPIMPackage#getDpimChannel_MessageBroker()
	...
	/**
	 * Sets the value of the '{@link es.unizar.disco.dice.DPIM.DpimChannel#getMessageBroker <em>Message Broker</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unizar.disco.dice.DPIM.DPIMPackage#getDpimChannel_ChannelDescription()
	...
	/**
	 * Sets the value of the '{@link es.unizar.disco.dice.DPIM.DpimChannel#getChannelDescription <em>Channel Description</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
