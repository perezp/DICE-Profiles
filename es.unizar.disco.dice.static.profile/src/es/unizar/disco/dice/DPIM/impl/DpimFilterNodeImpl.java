...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dpim Filter Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimFilterNodeImpl#getInputRatio <em>Input Ratio</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimFilterNodeImpl#getOutputRation <em>Output Ration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DpimFilterNodeImpl extends DpimComputationNodeImpl implements DpimFilterNode {
	/**
	...
	protected EClass eStaticClass() {
		return DPIMPackage.Literals.DPIM_FILTER_NODE;
	}
	...
	public void setInputRatio(String newInputRatio) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_FILTER_NODE__INPUT_RATIO, oldInputRatio, inputRatio));
	}
	...
	public void setOutputRation(String newOutputRation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_FILTER_NODE__OUTPUT_RATION, oldOutputRation, outputRation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DPIMPackage.DPIM_FILTER_NODE__INPUT_RATIO:
				return getInputRatio();
			case DPIMPackage.DPIM_FILTER_NODE__OUTPUT_RATION:
