/**
 */
package com.masdes.dam.Threats.util;
...
public class ThreatsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ThreatsSwitch<Adapter> modelSwitch =
		new ThreatsSwitch<Adapter>() {
			@Override
			public Adapter caseDaErrorPropRelation(DaErrorPropRelation object) {
				return createDaErrorPropRelationAdapter();
			}
			@Override
			public Adapter caseDaFaultGenerator(DaFaultGenerator object) {
				return createDaFaultGeneratorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.masdes.dam.Threats.DaErrorPropRelation <em>Da Error Prop Relation</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDaErrorPropRelationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.masdes.dam.Threats.DaFaultGenerator <em>Da Fault Generator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDaFaultGeneratorAdapter() {
		return null;
	}
