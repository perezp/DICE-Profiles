...
public class CassandraAdapterFactory extends AdapterFactoryImpl {
	...
	protected CassandraSwitch<Adapter> modelSwitch =
		new CassandraSwitch<Adapter>() {
			@Override
			public Adapter caseCassandraDB(CassandraDB object) {
				return createCassandraDBAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.dice.DTSM.Cassandra.CassandraDB <em>DB</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCassandraDBAdapter() {
		return null;
	}
