/**
 */
package es.unizar.disco.dice.DTSM.Cassandra.util;
 ...
 * @generated
 */
public class CassandraSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CassandraPackage.CASSANDRA_DB: {
				CassandraDB cassandraDB = (CassandraDB)theEObject;
				T result = caseCassandraDB(cassandraDB);
	 ...
	 * @generated
	 */
	public T caseCassandraDB(CassandraDB object) {
		return null;
	}
