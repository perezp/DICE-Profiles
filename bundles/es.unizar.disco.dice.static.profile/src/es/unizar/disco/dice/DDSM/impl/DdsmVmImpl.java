...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ddsm Vm</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#isIs64os <em>Is64os</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getImageId <em>Image Id</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getMaxCores <em>Max Cores</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getMaxRam <em>Max Ram</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getMaxStorage <em>Max Storage</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getMinCores <em>Min Cores</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getMinRam <em>Min Ram</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getMinStorage <em>Min Storage</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getOs <em>Os</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getSecurityGroup <em>Security Group</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getPrivateKey <em>Private Key</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getSshKey <em>Ssh Key</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getPublicAddress <em>Public Address</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getInstances <em>Instances</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DDSM.impl.DdsmVmImpl#getGenericSize <em>Generic Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DdsmVmImpl extends DdsmExternalComponentImpl implements DdsmVm {
	/**
	 ...
	 * @ordered
	 */
	protected static final Integer INSTANCES_EDEFAULT = new Integer(0);
	...
	protected EClass eStaticClass() {
		return DDSMPackage.Literals.DDSM_VM;
	}
	...
	public void setIs64os(boolean newIs64os) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__IS64OS, oldIs64os, is64os));
	}
	...
	public void setImageId(String newImageId) {
		...
		imageId = newImageId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__IMAGE_ID, oldImageId, imageId));
	}
	...
	public void setMaxCores(int newMaxCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__MAX_CORES, oldMaxCores, maxCores));
	}
	...
	public void setMaxRam(int newMaxRam) {
		...
		maxRam = newMaxRam;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__MAX_RAM, oldMaxRam, maxRam));
	}
	...
	public void setMaxStorage(int newMaxStorage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__MAX_STORAGE, oldMaxStorage, maxStorage));
	}
	...
	public void setMinCores(int newMinCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__MIN_CORES, oldMinCores, minCores));
	}
	...
	public void setMinRam(int newMinRam) {
		...
		minRam = newMinRam;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__MIN_RAM, oldMinRam, minRam));
	}
	...
	public void setMinStorage(int newMinStorage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__MIN_STORAGE, oldMinStorage, minStorage));
	}
	...
	public void setOs(String newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__OS, oldOs, os));
	}
	...
	public void setSecurityGroup(String newSecurityGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__SECURITY_GROUP, oldSecurityGroup, securityGroup));
	}
	...
	public void setPrivateKey(String newPrivateKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__PRIVATE_KEY, oldPrivateKey, privateKey));
	}
	...
	public void setSshKey(String newSshKey) {
		...
		sshKey = newSshKey;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__SSH_KEY, oldSshKey, sshKey));
	}
	...
	public void setPublicAddress(String newPublicAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__PUBLIC_ADDRESS, oldPublicAddress, publicAddress));
	}
	...
	public void setInstances(Integer newInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__INSTANCES, oldInstances, instances));
	}
	...
	public void setGenericSize(VMSize newGenericSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDSMPackage.DDSM_VM__GENERIC_SIZE, oldGenericSize, genericSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DDSMPackage.DDSM_VM__IS64OS:
				return isIs64os();
			case DDSMPackage.DDSM_VM__IMAGE_ID:
				return getImageId();
			case DDSMPackage.DDSM_VM__MAX_CORES:
				return getMaxCores();
			case DDSMPackage.DDSM_VM__MAX_RAM:
				return getMaxRam();
			case DDSMPackage.DDSM_VM__MAX_STORAGE:
				return getMaxStorage();
			case DDSMPackage.DDSM_VM__MIN_CORES:
				return getMinCores();
			case DDSMPackage.DDSM_VM__MIN_RAM:
				return getMinRam();
			case DDSMPackage.DDSM_VM__MIN_STORAGE:
				return getMinStorage();
			case DDSMPackage.DDSM_VM__OS:
				return getOs();
			case DDSMPackage.DDSM_VM__SECURITY_GROUP:
				return getSecurityGroup();
			case DDSMPackage.DDSM_VM__PRIVATE_KEY:
				return getPrivateKey();
			case DDSMPackage.DDSM_VM__SSH_KEY:
				return getSshKey();
			case DDSMPackage.DDSM_VM__PUBLIC_ADDRESS:
				return getPublicAddress();
			case DDSMPackage.DDSM_VM__INSTANCES:
				return getInstances();
			case DDSMPackage.DDSM_VM__GENERIC_SIZE:
