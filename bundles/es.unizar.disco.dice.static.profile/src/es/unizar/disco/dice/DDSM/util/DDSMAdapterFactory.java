...
public class DDSMAdapterFactory extends AdapterFactoryImpl {
	...
	protected DDSMSwitch<Adapter> modelSwitch =
		new DDSMSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDdsmSparkCluster(DdsmSparkCluster object) {
				return createDdsmSparkClusterAdapter();
			}
			@Override
			public Adapter caseDdsmMongoDBCluster(DdsmMongoDBCluster object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.dice.DDSM.DdsmSparkCluster <em>Ddsm Spark Cluster</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDdsmSparkClusterAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.dice.DDSM.DdsmMongoDBCluster <em>Ddsm Mongo DB Cluster</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
