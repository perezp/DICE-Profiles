...
public class DDSMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DDSMPackage.DDSM_SPARK_CLUSTER: {
				DdsmSparkCluster ddsmSparkCluster = (DdsmSparkCluster)theEObject;
				T result = caseDdsmSparkCluster(ddsmSparkCluster);
				if (result == null) result = caseDdsmMasterSlavePlatform(ddsmSparkCluster);
				if (result == null) result = caseDdsmInternalComponent(ddsmSparkCluster);
				if (result == null) result = caseDdsmComponent(ddsmSparkCluster);
				if (result == null) result = caseDdsmCloudElement(ddsmSparkCluster);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ddsm Spark Cluster</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ddsm Spark Cluster</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
