...
public abstract class CoreStorageNodeImpl extends CoreDataSourceImpl implements CoreStorageNode {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.CORE_STORAGE_NODE;
	}
	...
	public void setDatabase(String newDatabase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CORE_STORAGE_NODE__DATABASE, oldDatabase, database));
	}
	...
	public void setUser(String newUser) {
		...
		user = newUser;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CORE_STORAGE_NODE__USER, oldUser, user));
	}
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CORE_STORAGE_NODE__PASSWORD, oldPassword, password));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.CORE_STORAGE_NODE__DATABASE:
				return getDatabase();
			case CorePackage.CORE_STORAGE_NODE__USER:
				return getUser();
			case CorePackage.CORE_STORAGE_NODE__PASSWORD:
				return getPassword();
		}
