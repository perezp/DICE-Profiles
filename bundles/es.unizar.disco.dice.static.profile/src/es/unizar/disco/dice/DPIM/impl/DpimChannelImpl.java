...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dpim Channel</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimChannelImpl#getRate <em>Rate</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimChannelImpl#getMessageBroker <em>Message Broker</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimChannelImpl#getChannelDescription <em>Channel Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DpimChannelImpl extends DaConnectorImpl implements DpimChannel {
	/**
	...
	protected EClass eStaticClass() {
		return DPIMPackage.Literals.DPIM_CHANNEL;
	}
	...
	public void setRate(String newRate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_CHANNEL__RATE, oldRate, rate));
	}
	...
	public void setMessageBroker(String newMessageBroker) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_CHANNEL__MESSAGE_BROKER, oldMessageBroker, messageBroker));
	}
	...
	public NotificationChain basicSetChannelDescription(DiceChannelSpecification newChannelDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_CHANNEL__CHANNEL_DESCRIPTION, oldChannelDescription, newChannelDescription);
	...
	public void setChannelDescription(DiceChannelSpecification newChannelDescription) {
		if (newChannelDescription != channelDescription) {
			...
			if (channelDescription != null)
				msgs = ((InternalEObject)channelDescription).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DPIMPackage.DPIM_CHANNEL__CHANNEL_DESCRIPTION, null, msgs);
			if (newChannelDescription != null)
				msgs = ((InternalEObject)newChannelDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DPIMPackage.DPIM_CHANNEL__CHANNEL_DESCRIPTION, null, msgs);
			msgs = basicSetChannelDescription(newChannelDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_CHANNEL__CHANNEL_DESCRIPTION, newChannelDescription, newChannelDescription));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DPIMPackage.DPIM_CHANNEL__CHANNEL_DESCRIPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DPIMPackage.DPIM_CHANNEL__RATE:
				return getRate();
			case DPIMPackage.DPIM_CHANNEL__MESSAGE_BROKER:
