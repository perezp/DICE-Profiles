...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dpim Source Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimSourceNodeImpl#getStore <em>Store</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimSourceNodeImpl#getProvides <em>Provides</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimSourceNodeImpl#getSourceType <em>Source Type</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.impl.DpimSourceNodeImpl#getRate <em>Rate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DpimSourceNodeImpl extends DpimComputationNodeImpl implements DpimSourceNode {
	/**
	...
	protected EClass eStaticClass() {
		return DPIMPackage.Literals.DPIM_SOURCE_NODE;
	}
	...
	public NotificationChain basicSetStore(DiceDataVolume newStore, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_SOURCE_NODE__STORE, oldStore, newStore);
	...
	public void setStore(DiceDataVolume newStore) {
		if (newStore != store) {
			...
			if (store != null)
				msgs = ((InternalEObject)store).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DPIMPackage.DPIM_SOURCE_NODE__STORE, null, msgs);
			if (newStore != null)
				msgs = ((InternalEObject)newStore).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DPIMPackage.DPIM_SOURCE_NODE__STORE, null, msgs);
			msgs = basicSetStore(newStore, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_SOURCE_NODE__STORE, newStore, newStore));
	}
	...
	public NotificationChain basicSetProvides(DiceDataSpecification newProvides, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_SOURCE_NODE__PROVIDES, oldProvides, newProvides);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProvides(DiceDataSpecification newProvides) {
		if (newProvides != provides) {
			NotificationChain msgs = null;
			if (provides != null)
				msgs = ((InternalEObject)provides).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DPIMPackage.DPIM_SOURCE_NODE__PROVIDES, null, msgs);
			if (newProvides != null)
				msgs = ((InternalEObject)newProvides).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DPIMPackage.DPIM_SOURCE_NODE__PROVIDES, null, msgs);
			msgs = basicSetProvides(newProvides, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_SOURCE_NODE__PROVIDES, newProvides, newProvides));
	}
	...
	public void setSourceType(SourceType newSourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_SOURCE_NODE__SOURCE_TYPE, oldSourceType, sourceType));
	}
	...
	public void setRate(String newRate) {
		...
		rate = newRate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DPIMPackage.DPIM_SOURCE_NODE__RATE, oldRate, rate));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DPIMPackage.DPIM_SOURCE_NODE__STORE:
				return basicSetStore(null, msgs);
			case DPIMPackage.DPIM_SOURCE_NODE__PROVIDES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DPIMPackage.DPIM_SOURCE_NODE__PROVIDES:
				return getProvides();
			case DPIMPackage.DPIM_SOURCE_NODE__SOURCE_TYPE:
				return getSourceType();
			case DPIMPackage.DPIM_SOURCE_NODE__RATE:
				return getRate();
		}
