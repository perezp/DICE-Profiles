...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Dpim Storage Node</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link es.unizar.disco.dice.DPIM.DpimStorageNode#getRespondsTo <em>Responds To</em>}</li>
 *   <li>{@link es.unizar.disco.dice.DPIM.DpimStorageNode#getCrudRate <em>Crud Rate</em>}</li>
 * </ul>
 *
 * @see es.unizar.disco.dice.DPIM.DPIMPackage#getDpimStorageNode()
 * @model
 * @generated
 */
public interface DpimStorageNode extends StorageResource {
	/**
	 ...
	 * @see es.unizar.disco.dice.DPIM.DPIMPackage#getDpimStorageNode_RespondsTo()
	...
	/**
	 * Sets the value of the '{@link es.unizar.disco.dice.DPIM.DpimStorageNode#getRespondsTo <em>Responds To</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unizar.disco.dice.DPIM.DPIMPackage#getDpimStorageNode_CrudRate()
	...
	/**
	 * Sets the value of the '{@link es.unizar.disco.dice.DPIM.DpimStorageNode#getCrudRate <em>Crud Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
