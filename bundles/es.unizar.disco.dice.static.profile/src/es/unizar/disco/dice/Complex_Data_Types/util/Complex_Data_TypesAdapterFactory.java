...
public class Complex_Data_TypesAdapterFactory extends AdapterFactoryImpl {
	...
	protected Complex_Data_TypesSwitch<Adapter> modelSwitch =
		new Complex_Data_TypesSwitch<Adapter>() {
			@Override
			public Adapter caseDiceDataVolume(DiceDataVolume object) {
				return createDiceDataVolumeAdapter();
			}
			@Override
			public Adapter caseDiceDataSpecification(DiceDataSpecification object) {
				return createDiceDataSpecificationAdapter();
			}
			@Override
			public Adapter caseDiceChannelSpecification(DiceChannelSpecification object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.dice.Complex_Data_Types.DiceDataVolume <em>Dice Data Volume</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDiceDataVolumeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.dice.Complex_Data_Types.DiceDataSpecification <em>Dice Data Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDiceDataSpecificationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.dice.Complex_Data_Types.DiceChannelSpecification <em>Dice Channel Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
