/**
 */
package es.unizar.disco.dice.Basic_Data_Types.util;
...
public class Basic_Data_TypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Basic_Data_TypesPackage.NFP_PRIVACY: {
				NFP_Privacy nfP_Privacy = (NFP_Privacy)theEObject;
				T result = caseNFP_Privacy(nfP_Privacy);
			...
			case Basic_Data_TypesPackage.FIREWALL_RULE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>NFP Privacy</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>NFP Privacy</em>'.
